  ...
  return (
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-grow">
        ...
        {/* 🚨 CATEGORY & EDITED TAG WRAPPER */}
        <div className="flex items-center justify-between mb-2 gap-2">
          <p className="text-[10px] font-black text-[#D4AF37] uppercase tracking-[0.2em] truncate">
            {item.category}
          </p>

          {/* 🚨 THE EDITED TAG */}
          {item.is_edited && (
            <span className="text-[8px] bg-gray-100 text-gray-500 px-2 py-0.5 rounded font-black uppercase tracking-widest border border-gray-200 whitespace-nowrap shadow-sm">
              Edited
            </span>
          )}
        </div>
